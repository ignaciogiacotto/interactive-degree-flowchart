...
- 🗺️ **Visualización de Correlatividades:** Mapa interactivo de nodos y conexiones.
- ✅ **Seguimiento de Progreso:** Marcado de materias (pendiente/regular/aprobada).
- 💾 **Persistencia Local:** El progreso se guarda automáticamente en el navegador (LocalStorage).
- 🌓 **Modo Oscuro/Claro:** Interfaz adaptable y optimizada para lectura.
- 🚀 **Tech Stack:** React, TypeScript, React Flow y Lucide Icons.
